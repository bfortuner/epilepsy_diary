...
class Event(Base):
    ...
    def __init__(self, user_id, event_time=datetime.now(), event_type=None, 
            event_severity=None, event_duration=None, tracking_status_name='CREATED'):
    ...
    def __repr__(self):
        return '<Event: %r, User: %s, EventType: %s>' % (self.id, self.user.username, self.event_type)
